/** Catholic Bible Online — St. Michael's Lent novena (canonical outbound for all St. Michael content) */
export const CBO_ST_MICHAELS_LENT_GUIDE =
  "https://catholicbibleonline.com/blog/st-michaels-lent-novena-prayer-guide-us-2026/";

/** 46-day novena index (daily prayer pages) */
export const CBO_ST_MICHAELS_LENT_NOVENA =
  "https://catholicbibleonline.com/novenas/st-michaels-lent-novena/";

export const cboStMichaelsLentNovenaDay = (day: number) =>
  `https://catholicbibleonline.com/novenas/st-michaels-lent-novena/day-${day}/`;
