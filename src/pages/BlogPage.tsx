...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Novena for Legal Cases: 9-Day Prayer for Court & Justice",
    excerpt: "Novena for legal cases — 9-day Catholic prayer for court hearings, lawsuits, and just outcomes.",
    date: "2026-06-02",
    readTime: "9 min",
    category: "Prayers & Devotions",
    icon: Gavel,
  ...
  },
  {
    ...
    excerpt: "Catholic saints and what they are known for — patron saints for health, work, travel, family, and more. Find your patron and learn how to ask for intercession.",
    date: "2026-04-24",
    readTime: "20 min",
    category: "Saints & Intercession",
    icon: Users,
  ...
  },
  {
    ...
    excerpt: "Do Catholics believe in ghosts? Church teaching on purgatory, demonic deception, haunted houses, and how to protect your home.",
    date: "2026-04-16",
    readTime: "14 min",
    category: "Spiritual Warfare",
    icon: Ghost,
  ...
  { id: 1255, slug: "st-joseph-novena-buying-house-guide", title: "Novena to Saint Joseph for Buying a House: A Catholic Prayer Guide", excerpt: "A complete Catholic guide to praying to Saint Joseph for help buying or selling a home — the tradition of burying the statue, how to pray the novena, and how to bless your new home.", date: "2026-05-01", readTime: "5 min", category: "Prayer & Devotion", icon: Home, bgColor: "bg-yellow-50", iconColor: "text-yellow-600" },
