        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <LinkedText className="text-text leading-relaxed mb-6" currentSlug="why-do-catholics">
            ...
            <ArticleBottomCTA title="How Deep Is Your Catholic Faith?" description="Take our assessment and receive a personalized guide to understanding and living your Catholic faith." />
          </div>
        </article>
        <Footer />
      </div>
