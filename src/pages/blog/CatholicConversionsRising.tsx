      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="Curious About the Catholic Faith?" description="Take our faith assessment and receive a personalized guide to exploring and deepening your Catholic life." />
          </div>
        </article>
        <Footer />
      </div>
