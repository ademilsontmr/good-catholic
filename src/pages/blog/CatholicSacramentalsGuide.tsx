    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Catholic Sacramentals Guide", url: "https://guidecatholic.com/blog/catholic-sacramentals-guide/" },
        ]}
      />
...
<RelatedArticles currentSlug="catholic-sacramentals-guide" />
            ...
            <ArticleBottomCTA title="Discover Your Spiritual Tools" description="Take our quiz to learn which sacramentals best support your spiritual journey." />
          </div>
        </article>
