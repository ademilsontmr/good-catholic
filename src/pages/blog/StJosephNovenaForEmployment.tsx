  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="St. Joseph Novena for employment and finding a job — 9-day Catholic prayer with full text, step-by-step guide, and when to pray for work and financial stability. Full prayer text, step-by-step guide, and FAQs. Full prayer text, step-by-step guide, and FAQs." />
        <meta name="keywords" content="" />
        <link rel="canonical" href="https://guidecatholic.com/blog/st-joseph-novena-for-employment/" />
        <meta name="robots" content="index, follow" />
      </Helmet>
      <ArticleSchema title="St. Joseph Novena for Employment: 9-Day Prayer to Find a Job (Full Text)" description="St. Joseph Novena for employment and finding a job — 9-day Catholic prayer with full text, step-by-step guide, and when to pray for work and financial stability. Full prayer text, step-by-step guide, and FAQs. Full prayer text, step-by-step guide, and FAQs." url="https://guidecatholic.com/blog/st-joseph-novena-for-employment/" datePublished="2026-05-30" />
      <BreadcrumbSchema
        items={[
