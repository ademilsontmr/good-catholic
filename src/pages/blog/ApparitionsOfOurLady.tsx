    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Apparitions of Our Lady", url: "https://guidecatholic.com/blog/apparitions-of-our-lady/" },
        ]}
      />
...
<RelatedArticles currentSlug="apparitions-of-our-lady" />
            ...
            <ArticleBottomCTA title="Deepen Your Relationship with Our Lady" description="Take our faith quiz and discover practical steps to grow in your Catholic life under Mary's intercession." />
          </div>
        </article>
