...
<RelatedArticles currentSlug="saint-benedict-medal" />
            ...
            <ArticleBottomCTA title="Discover How Your Faith Life Is" description="Take our quiz and receive a personalized assessment of your Catholic journey — and practical steps to grow stronger in faith." />
          </div>
        </article>
        <Footer />
      </div>
