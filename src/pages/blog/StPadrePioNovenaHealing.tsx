  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="St. Padre Pio Novena for healing — 9-day Catholic prayer with full text. Physical and spiritual healing through the intercession of Padre Pio. Full prayer text, step-by-step guide, and FAQs. Full prayer text, step-by-step guide, and FAQs." />
        <meta name="keywords" content="" />
        <link rel="canonical" href="https://guidecatholic.com/blog/st-padre-pio-novena-healing/" />
        <meta name="robots" content="index, follow" />
      </Helmet>
      <ArticleSchema title="St. Padre Pio Novena for Healing: 9-Day Prayer (Full Text)" description="St. Padre Pio Novena for healing — 9-day Catholic prayer with full text. Physical and spiritual healing through the intercession of Padre Pio. Full prayer text, step-by-step guide, and FAQs. Full prayer text, step-by-step guide, and FAQs." url="https://guidecatholic.com/blog/st-padre-pio-novena-healing/" datePublished="2026-05-30" />
      <BreadcrumbSchema
        items={[
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8 p-6 bg-amber-50/80 border border-amber-200/60 rounded-xl">
                <p className="text-lg text-text leading-relaxed font-medium">The St. Padre Pio novena for healing asks the stigmatic friar to intercede for physical, emotional, and spiritual recovery. Pray nine consecutive days with Mass and Confession when possible; Padre Pio heard confessions for hours and believed suffering united to Christ brings grace.</p>
              </div>
