          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mb-8 p-6 bg-amber-50/80 border border-amber-200/60 rounded-xl">
                <p className="text-lg text-text leading-relaxed font-medium">Pope Leo XIV continues the papacy after Francis — Catholics pray for the pope as successor of Peter, follow his teaching on faith and morals, and look to Rome for unity. Biographical and policy details develop as his pontificate unfolds.</p>
              </div>
            ...
            <ArticleBottomCTA title="Deepen Your Catholic Faith" description="A new pope is a call to renewal. Take our faith quiz and receive a personalized guide to growing in your Catholic life." />
          </div>
        </article>
