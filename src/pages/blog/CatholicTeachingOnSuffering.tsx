    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Why Does God Allow Suffering", url: "https://guidecatholic.com/blog/why-does-god-allow-suffering-catholic/" },
        ]}
      />
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="How Deep Is Your Catholic Faith?" description="Take our assessment and receive a personalized guide to growing in faith, especially in times of suffering and doubt." />
          </div>
        </article>
        <Footer />
      </div>
