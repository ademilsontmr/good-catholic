      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="Discover Your Catholic Faith" description="Take our assessment and receive a personalized guide to growing in your knowledge of the faith." />
          </div>
        </article>
        <Footer />
      </div>
