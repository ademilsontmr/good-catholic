    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Beauty and the Catholic Faith", url: "https://guidecatholic.com/blog/beauty-and-the-catholic-faith/" },
        ]}
      />
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mb-8 p-6 bg-amber-50/80 border border-amber-200/60 rounded-xl">
                <p className="text-lg text-text leading-relaxed font-medium">Beauty is a transcendental pointing to God — sacred art, music, and architecture lift the soul toward heaven. Catholics reject utilitarian ugliness in churches; beauty in liturgy, icons, and creation evangelizes and forms worshippers when ordered to truth and goodness.</p>
              </div>
            ...
            <ArticleBottomCTA title="How Deep Is Your Catholic Faith?" description="Take our assessment and receive a personalized guide to growing in your knowledge of Catholic theology and tradition." />
          </div>
        </article>
        <Footer />
      </div>
