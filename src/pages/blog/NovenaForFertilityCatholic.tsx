        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <header className="mb-8">
              ...
              <p className="text-xl text-text-muted leading-relaxed">Novena for fertility — 9-day Catholic prayer for couples trying to conceive, with full prayer text.</p>
            </header>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-8 p-6 bg-amber-50/80 border border-amber-200/60 rounded-xl">
                <p className="text-lg text-text leading-relaxed font-medium">A novena for fertility asks St. Gerard Majella, St. Anne, or Mary for openness to children — nine days of prayer alongside ethical medical care and NaPro technology when appropriate. The Church rejects IVF; prayer supports couples trusting God&apos;s plan for parenthood.</p>
              </div>
