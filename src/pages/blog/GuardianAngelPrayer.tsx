        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-accent/10 to-primary/10 rounded-2xl text-center">
              <h3 className="font-display text-2xl font-bold text-text mb-4">Build a Daily Prayer Habit</h3>
              <p className="text-text-muted mb-6">Get a personalized Catholic growth plan for prayer and spiritual discipline.</p>
