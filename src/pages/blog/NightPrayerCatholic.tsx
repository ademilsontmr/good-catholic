      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="How Is Your Prayer Life?" description="Take our Catholic faith assessment and receive a personalized guide to building a stronger prayer routine." />
          </div>
        </article>
        <Footer />
      </div>
