    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "St. Jude Prayer", url: "https://guidecatholic.com/blog/st-jude-prayer/" },
        ]}
      />
      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="How Deep Is Your Catholic Faith?" description="Take our assessment and receive a personalized guide to growing in your prayer life and devotion to the saints." />
          </div>
        </article>
        <Footer />
      </div>
