      ...
      <div className="min-h-screen bg-background">
        ...
        <article className="py-12">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <ArticleBottomCTA title="Where Are You on Your Catholic Journey?" description="Take our faith assessment and receive a personalized guide to help you on your path to the Catholic Church." />
          </div>
        </article>
        <Footer />
      </div>
