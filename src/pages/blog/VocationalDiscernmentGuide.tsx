    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Vocational Discernment Guide", url: "https://guidecatholic.com/blog/vocational-discernment-guide/" },
        ]}
      />
...
<RelatedArticles currentSlug="vocational-discernment-guide" />
            ...
            <ArticleBottomCTA title="Discover Your Unique Calling" description="Take our vocational assessment and receive personalized guidance for your discernment journey." />
          </div>
        </article>
